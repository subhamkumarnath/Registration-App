...
<body>
    <div class="main">
        ...
        <form action="register1" method="post">
            ...
            <div class="form-content">
                <label for="telephoneHome">Telephone - Home</label>
                <input type="text" name="telephoneHome" id="telephoneHome" required>
            </div>
            <div class="form-content">
                <label for="telephoneMobile">Telephone - Mobile</label>
                <input type="text" name="telephoneMobile" id="telephoneMobile" required>
            </div>
            <div>
